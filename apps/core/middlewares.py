...
class JWTAuthenticationMiddleware(BaseMiddleware, MatchRouteMiddlewareMixin):
  _routes = [
    ...
    r"^/?api/projects/[a-zA-Z0-9-]+/upload-cover-photo/?$",
    r"^/?api/projects/[a-zA-Z0-9-]+/tasks/?$",
    r"^/?api/projects/[a-zA-Z0-9-]+/tasks/[a-zA-Z0-9-]+/?$",
    r"^/?api/projects/[a-zA-Z0-9-]+/tasks/[a-zA-Z0-9-]+/mark-unmark/?$",
    ...
    r"^/?api/notifications/sync/?$",
    r"^/?api/notifications/read/[a-zA-Z0-9-]+/?$",
  ]
